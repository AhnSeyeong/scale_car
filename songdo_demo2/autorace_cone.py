...
class ConeFollower:
    def __init__(self):
        ...
        self.offset = rospy.get_param('~offset', 0.3)
    ...
    def detect_cones(self, points):
        ...
        # 첫 번째 DBSCAN - 개별 콘 감지
        db = DBSCAN(eps=0.1, min_samples=1).fit(points)
        labels = db.labels_
        ...
        db_lr = DBSCAN(eps=0.62, min_samples=1).fit(centroids)
