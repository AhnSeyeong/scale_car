...
class perception:
    def __init__(self):
        ...
        self.roi_y_l = rospy.get_param('~roi_y_l', 280)
        ...
        self.kidszone_threshold = 500
        self.cooldown = 18
        self.last_count_time = 0
        self.mask = None

        # YELLOW HSV RANGE
        self.lower_yellow = np.array([20, 15, 180])
